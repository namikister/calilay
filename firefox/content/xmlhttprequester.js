function calilay_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
calilay_xmlhttpRequester.prototype.contentStartRequest = function(details) {
    ...
    case "https":
    case "ftp":
        this.chromeWindow.setTimeout(calilay_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
        break;
    default:
...
calilay_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
calilay_xmlhttpRequester.prototype.setupRequestEvent = function(unsafeContentWin, req, event, details) {
    if (details[event]) {
        req[event] = function() {
            var responseState = {
                __exposedProps__: {
